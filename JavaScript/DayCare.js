function validateForms() {
    //Variables
    var emergencyContactName = document.forms["DayCareFrom"]["emergencyContactName"].value;
    var emergencyContactPhone = document.forms["DayCareFrom"]["emergencyContactPhone"].value;
    var ResDesc = document.forms["DayCareFrom"]["ResDesc"].value;
